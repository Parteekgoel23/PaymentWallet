...
public class AddWalletMicroservice {
	...
	public SuccessResponse addMoney(@RequestBody UserDto userDto,Double Amount) throws WalletAccountDoNotExistsException {
		String msg = walletService.addMoney(userDto,Amount);
